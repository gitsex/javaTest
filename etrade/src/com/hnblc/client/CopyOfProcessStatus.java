...
public class CopyOfProcessStatus {
	...
	public static int logisticstinfodifftime =1; //物流推送频率
	/**
	 * @param args
	 */
...
//		{
//			
//			List<Map<String, String>> Order =DBsql.getOrderList("where orderNumber='1277975557566227' AND logisticsExchangeStatus=1   ");
//			  
